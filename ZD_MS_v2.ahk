...
loop, %cycles%
{
	...
	FileAppend , %A_DD%/%A_MM%/%A_YYYY% %A_Hour%:%A_Min%:%A_Sec% - cycle %A_index% started `n , connection.log	
	
	;Test 1: Connect & disconnect gracefully
	TrayTip , Status,  Test 1: Connect & disconnect gracefully, 2, 1
	FileAppend , %A_DD%/%A_MM%/%A_YYYY% %A_Hour%:%A_Min%:%A_Sec% -  Test 1: Connect & disconnect gracefully `n , connection.log	
	Connect()
	Check()
	Disconnect()	
	
	;Test 2: Abort connection
	TrayTip , Status,  Test 2: Abort connection , 2, 1
	FileAppend , %A_DD%/%A_MM%/%A_YYYY% %A_Hour%:%A_Min%:%A_Sec% -  Test 2: Abort connection `n , connection.log	
	Connect()
	sleep 1500
	...
	;Test 3: Abort download
	TrayTip , Status,  Test 3: Abort download , 2, 1
	FileAppend , %A_DD%/%A_MM%/%A_YYYY% %A_Hour%:%A_Min%:%A_Sec% -  Test 3: Abort download started `n , connection.log
	Connect()		
	If NOT InternetCheckConnection() ;Wait for connection
		sleep 1000		
	FileAppend , %A_DD%/%A_MM%/%A_YYYY% %A_Hour%:%A_Min%:%A_Sec% - Connection abortion set `n , connection.log	
	SetTimer, Disconnect, 2000,
	DownloadFile()	
	
	;Test 4: Eject gracefully 
	TrayTip , Status, Test 4: Eject gracefully , 2, 1
	FileAppend , %A_DD%/%A_MM%/%A_YYYY% %A_Hour%:%A_Min%:%A_Sec% - Test 4 - Eject gracefully  `n , connection.log	
	...
	TrayTip , Status, Test 5: Eject while connecting , 2, 1
	FileAppend , %A_DD%/%A_MM%/%A_YYYY% %A_Hour%:%A_Min%:%A_Sec% - Test 5: Eject while connecting  `n , connection.log
	...
	TrayTip , Status, Test 5: Eject after connection established , 2, 1
	FileAppend , %A_DD%/%A_MM%/%A_YYYY% %A_Hour%:%A_Min%:%A_Sec% - Test 6: Eject after connection established  `n , connection.log
	...
	;Test 7: Eject while donwloading 
	TrayTip , Status, Test 7: Eject while donwloading , 2, 1
	FileAppend , %A_DD%/%A_MM%/%A_YYYY% %A_Hour%:%A_Min%:%A_Sec% - Test 7: Eject while donwloading  `n , connection.log
	
	Connect()
	SetTimer, Eject, 1500,
	FileAppend , %A_DD%/%A_MM%/%A_YYYY% %A_Hour%:%A_Min%:%A_Sec% - Eject timer set `n , connection.log	
	DownloadFile()
	Eject:
	SetTimer, Eject, OFF,	
	Drive, eject, %drive%
...
Eject(graceful)
{
	...
	Drive, eject, %drive%:
	FileAppend , %A_DD%/%A_MM%/%A_YYYY% %A_Hour%:%A_Min%:%A_Sec% - Eject initiated `n , connection.log	
...
/*PlugOut()
{
	...
	DriveGet , var , status, %drive%:\
	
	TrayTip , Note , Please unplug the device , 3, 2	
	...
	FileAppend , %A_DD%/%A_MM%/%A_YYYY% %A_Hour%:%A_Min%:%A_Sec% - Device Unpluged `n , connection.log	
	
	random, rand , 2000, 3000
    sleep, %rand%
	
	TrayTip , Note , Please plug it back , 3, 2	
